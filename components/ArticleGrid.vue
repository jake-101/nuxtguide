<template>
  <div>
    ...
    >
      ...
      >
        <div
          class="rounded overflow-hidden shadow-lg bg-brown-900 flex h-full items-center justify-between flex-col flex-1"
        >
          <p></p>
          ...
          <p class="mb-4 text-xs text-teal-700 justify-end">Version 2.0</p>
