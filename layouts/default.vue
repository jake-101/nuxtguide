  ...
  <div id="app">
    <no-ssr>
      <Reveal class="sidemenu">
        ...
        <nuxt-link
          v-for="c in cats"
          :key="c.slug"
          class="text-brown-700 hover:text-brown-800"
          :to="`/${c.slug}`"
        >{{c.title}}</nuxt-link>
      </Reveal>
    </no-ssr>
    ...
    <footer class="m-12">
      <ul class="flex justify-around text-gray-700 text-xs font-light">
        ...
        <li class="mx-2">
          <n-link class="text-gray-800 hover:underline" to="/pages/colophon">Colophon</n-link>
        </li>
        <li class="mx-2">
          <a class="text-gray-800 hover:underline" href="https://twitter.com/nuxtguide">Twitter</a>
        </li>
      </ul>
    </footer>
  </div>
